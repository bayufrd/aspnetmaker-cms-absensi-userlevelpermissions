...
public partial class project2 {
    ...
    public class User2 : DbTable
    {
        ...
        public readonly DbField<MySqlDbType> _userlevel;
        ...
        public User2()
        {
            ...
            _username = new(this, "x__username", 200, MySqlDbType.VarString) {
                ...
                CustomMessage = Language.FieldPhrase("user2", "_username", "CustomMsg"),
                IsUpload = false
            };
            _username.Raw = true;
            ...
            // userlevel
            _userlevel = new(this, "x__userlevel", 3, MySqlDbType.Int32) {
                Name = "userlevel",
                Expression = "`userlevel`",
                BasicSearchExpression = "`userlevel`",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("user2", "_userlevel", "CustomMsg"),
                IsUpload = false
            };
            _userlevel.Raw = true;
            _userlevel.Lookup = new Lookup<DbField>(_userlevel, "user2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "User2View" => Language.Phrase("View"),
                "User2Edit" => Language.Phrase("Edit"),
                "User2Add" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("User2Delete", parm)); // DN
        }
        ...
        public string AddUserIDFilter(string filter = "", string id = "")
        {
            ...
            if (!UserIDAllow(id) && !Security.IsAdmin) {
                filterWrk = Security.UserLevelList();
                if (!Empty(filterWrk))
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM user";
