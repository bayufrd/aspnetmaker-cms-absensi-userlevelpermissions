...
public partial class project2 {
    ...
    public class BukuTamuEditBase : BukuTamu
    {
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // umur
            umur.SetDbValue(rsnew, umur.CurrentValue, umur.ReadOnly);

            // tanggal_kunjungan
            tanggal_kunjungan.SetDbValue(rsnew, ConvertToDateTime(tanggal_kunjungan.CurrentValue, tanggal_kunjungan.FormatPattern), tanggal_kunjungan.ReadOnly);

            // tujuan
            tujuan.SetDbValue(rsnew, tujuan.CurrentValue, tujuan.ReadOnly);

            // komentar
            komentar.SetDbValue(rsnew, komentar.CurrentValue, komentar.ReadOnly);
            return rsnew;
        }
