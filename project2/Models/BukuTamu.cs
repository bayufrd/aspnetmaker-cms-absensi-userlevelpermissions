...
public partial class project2 {
    ...
    {
        get => HttpData.Resolve<BukuTamu>("buku_tamu");
        set => HttpData["buku_tamu"] = value;
    }

    /// <summary>
    /// Table class for buku_tamu
    /// </summary>
    public class BukuTamu : DbTable
    {
        ...
        public DbChart UmurPengunjung;

        public readonly DbField<MySqlDbType> id;

        public readonly DbField<MySqlDbType> nama;

        public readonly DbField<MySqlDbType> umur;

        public readonly DbField<MySqlDbType> tanggal_kunjungan;

        public readonly DbField<MySqlDbType> tujuan;

        public readonly DbField<MySqlDbType> komentar;
        ...
        public BukuTamu()
        {
            ...
            Name = "buku_tamu";
            Type = "TABLE";
            UpdateTable = "buku_tamu"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // id
            id = new(this, "x_id", 3, MySqlDbType.Int32) {
                Name = "id",
                Expression = "`id`",
                ...
                CustomMessage = Language.FieldPhrase("buku_tamu", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            // nama
            nama = new(this, "x_nama", 200, MySqlDbType.VarString) {
                Name = "nama",
                Expression = "`nama`",
                UseBasicSearch = true,
                ...
                CustomMessage = Language.FieldPhrase("buku_tamu", "nama", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("nama", nama);

            // umur
            umur = new(this, "x_umur", 3, MySqlDbType.Int32) {
                Name = "umur",
                Expression = "`umur`",
                BasicSearchExpression = "`umur`",
                DateTimeFormat = -1,
                VirtualExpression = "`umur`",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("buku_tamu", "umur", "CustomMsg"),
                IsUpload = false
            };
            umur.Raw = true;
            Fields.Add("umur", umur);

            // tanggal_kunjungan
            tanggal_kunjungan = new(this, "x_tanggal_kunjungan", 133, MySqlDbType.Date) {
                Name = "tanggal_kunjungan",
                Expression = "`tanggal_kunjungan`",
                BasicSearchExpression = CastDateFieldForLike("`tanggal_kunjungan`", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "`tanggal_kunjungan`",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("buku_tamu", "tanggal_kunjungan", "CustomMsg"),
                IsUpload = false
            };
            tanggal_kunjungan.Raw = true;
            Fields.Add("tanggal_kunjungan", tanggal_kunjungan);

            // tujuan
            tujuan = new(this, "x_tujuan", 200, MySqlDbType.Text) {
                Name = "tujuan",
                Expression = "`tujuan`",
                UseBasicSearch = true,
                ...
                Required = true, // Required field
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("buku_tamu", "tujuan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("tujuan", tujuan);

            // komentar
            komentar = new(this, "x_komentar", 200, MySqlDbType.Text) {
                Name = "komentar",
                Expression = "`komentar`",
                UseBasicSearch = true,
                BasicSearchExpression = "`komentar`",
                DateTimeFormat = -1,
                VirtualExpression = "`komentar`",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Required = true, // Required field
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("buku_tamu", "komentar", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("komentar", komentar);

            // UmurPengunjung
            UmurPengunjung = new DbChart(this, "1001")
            {
                ChartVar = "UmurPengunjung",
                Name = "UmurPengunjung",
                XFieldName = "tanggal_kunjungan",
                YFieldName = "umur",
                SeriesFieldName = "",
                SeriesType = 0,
                SummaryType = "AVG",
                ...
                SortSequence = "",
                Position = 4,
                PageBreakType = "before",
                SqlSelect = "SELECT `tanggal_kunjungan` AS ChartXField, '' AS ChartSField, AVG(`umur`) AS ChartYField FROM ",
                SqlGroupBy = "`tanggal_kunjungan`",
                SqlOrderBy = "",
                SeriesDateType = "",
                XAxisDateFormat = "0",
                ID = "buku_tamu_UmurPengunjung" // Chart ID
            };
            UmurPengunjung.SetParameter("type", "1001"); // Chart type
            UmurPengunjung.SetParameter("seriestype", "0"); // Chart series type
            UmurPengunjung.SetParameter("caption", UmurPengunjung.Caption); // Chart caption
            UmurPengunjung.SetParameter("xaxisname", UmurPengunjung.XAxisName); // X axis name
            UmurPengunjung.SetParameter("yaxisname", UmurPengunjung.YAxisName); // Y axis name
            UmurPengunjung.SetParameter("shownames", "1"); // Show names
            UmurPengunjung.SetParameter("showvalues", "1"); // Show values
            UmurPengunjung.SetParameter("showhovercap", "1"); // Show hover
            UmurPengunjung.SetParameter("alpha", 50); // Chart alpha
            UmurPengunjung.SetParameter("options.plugins.legend.display", false);
            UmurPengunjung.SetParameter("options.plugins.legend.fullWidth", false);
            UmurPengunjung.SetParameter("options.plugins.legend.reverse", false);
            UmurPengunjung.SetParameter("options.plugins.legend.rtl", false);
            UmurPengunjung.SetParameter("options.plugins.legend.labels.usePointStyle", false);
            UmurPengunjung.SetParameter("options.plugins.title.display", false);
            UmurPengunjung.SetParameter("options.plugins.tooltip.enabled", false);
            UmurPengunjung.SetParameter("options.plugins.tooltip.intersect", false);
            UmurPengunjung.SetParameter("options.plugins.tooltip.displayColors", false);
            UmurPengunjung.SetParameter("options.plugins.tooltip.rtl", false);
            UmurPengunjung.SetParameter("options.plugins.filler.propagate", false);
            UmurPengunjung.SetParameter("options.animation.animateRotate", false);
            UmurPengunjung.SetParameter("options.animation.animateScale", false);
            UmurPengunjung.SetParameter("options.scales.r.angleLines.display", false);
            UmurPengunjung.SetParameter("options.plugins.stacked100.enable", false);
            UmurPengunjung.SetParameter("dataset.showLine", false);
            UmurPengunjung.SetParameter("dataset.spanGaps", false);
            UmurPengunjung.SetParameter("dataset.steppedLine", false);
            UmurPengunjung.SetParameter("dataset.circular", false);
            UmurPengunjung.SetParameter("scale.offset", false);
            UmurPengunjung.SetParameter("scale.gridLines.offsetGridLines", false);
            UmurPengunjung.SetParameter("options.plugins.datalabels.clamp", false);
            UmurPengunjung.SetParameter("options.plugins.datalabels.clip", false);
            UmurPengunjung.SetParameter("options.plugins.datalabels.display", false);
            UmurPengunjung.SetParameter("annotation1.show", false);
            UmurPengunjung.SetParameter("annotation1.secondaryYAxis", false);
            UmurPengunjung.SetParameter("annotation2.show", false);
            UmurPengunjung.SetParameter("annotation2.secondaryYAxis", false);
            UmurPengunjung.SetParameter("annotation3.show", false);
            UmurPengunjung.SetParameter("annotation3.secondaryYAxis", false);
            UmurPengunjung.SetParameter("annotation4.show", false);
            UmurPengunjung.SetParameter("annotation4.secondaryYAxis", false);
            Charts.Add(UmurPengunjung.Name, UmurPengunjung); // Chart name as key // DN
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                umur.DbValue = row["umur"]; // Set DB value only
                tanggal_kunjungan.DbValue = row["tanggal_kunjungan"]; // Set DB value only
                tujuan.DbValue = row["tujuan"]; // Set DB value only
                komentar.DbValue = row["komentar"]; // Set DB value only
            } catch {}
        }
        ...
        public async Task RenderListRow()
        {
            ...
            tanggal_kunjungan.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            komentar.EditValue = komentar.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(umur);
                        doc.ExportCaption(tanggal_kunjungan);
                        doc.ExportCaption(tujuan);
                        doc.ExportCaption(komentar);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(nama);
                        doc.ExportCaption(umur);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(umur);
                            await doc.ExportField(tanggal_kunjungan);
                            await doc.ExportField(tujuan);
                            await doc.ExportField(komentar);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(nama);
                            await doc.ExportField(umur);
