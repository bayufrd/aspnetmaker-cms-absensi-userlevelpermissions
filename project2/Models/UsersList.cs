...
public partial class project2 {
    ...
    public class UsersListBase : Users
    {
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(user_level_id.AdvancedSearch.ToJson())); // Field user_level_id
        ...
        protected bool RestoreFilterList() {
            ...
            // Field user_level_id
            if (filter?.TryGetValue("x_user_level_id", out sv) ?? false) {
                user_level_id.AdvancedSearch.SearchValue = sv;
                user_level_id.AdvancedSearch.SearchOperator = filter["z_user_level_id"];
                user_level_id.AdvancedSearch.SearchCondition = filter["v_user_level_id"];
                user_level_id.AdvancedSearch.SearchValue2 = filter["y_user_level_id"];
                user_level_id.AdvancedSearch.SearchOperator2 = filter["w_user_level_id"];
                user_level_id.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(user_level_id); // user_level_id
        ...
        public async Task RenderListOptions()
        {
            ...
            listOption?.SetBody("<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" + RowCount + "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" + HtmlEncode(user_id.CurrentValue) + "\" data-ew-action=\"select-key\"></div>");
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("user_level_id")); // DN
            }
