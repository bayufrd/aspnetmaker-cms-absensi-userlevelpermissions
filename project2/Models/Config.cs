...
public partial class project2 {
    ...
    public static partial class Config
    {
        ...
        public const string ProjectClassName = "ASPNETMaker2024.Models.project2"; // DN
        ...
        public const string ProjectName = "project2"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}"; // Project ID (GUID)

        public static string RandomKey = "Yu1jyrP97P80rcEY"; // Random key for encryption // DN

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/project2.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        // Export Log
        public static string ExportPath = "export-6b580f13-1c7b-4cd6-99ed-4caef98066cd"; // Export folder
        ...
        public static string UserLevelTable = "userlevels"; // For SQL
        ...
        public static string UserLevelPrivTable = "userlevelpermissions"; // For SQL
        ...
        public static string UserPrimaryKeyFieldName = "user_id";
        ...
        public static string UserLevelFieldName = "user_level_id";
