...
public partial class project2 {
    ...
    public static void SetupMenus()
    {
        ...
        List<MenuItem> menuItems = [
            new(1, "mi_buku_tamu", "BukuTamuList", -1, "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}buku_tamu", false, false, "", "", false, true),
            new(3, "mi_userlevelpermissions", "UserlevelpermissionsList", -1, "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}userlevelpermissions", false, false, "", "", false, true),
            new(4, "mi_userlevels", "UserlevelsList", -1, "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}userlevels", false, false, "", "", false, true),
            new(5, "mi_users", "UsersList", -1, "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}users", false, false, "", "", false, true),
            new(6, "mi_absensi", "AbsensiList", -1, "{6B580F13-1C7B-4CD6-99ED-4CAEF98066CD}absensi", false, false, "", "", false, true),
        ];
    ...
    /// </summary>
    /// <returns>DatabaseConnection instance</returns>
    public static DatabaseConnection<MySqlConnection, MySqlDbType> UserTableConn => UserTable.Connection; // DN
        ...
        foreach (AdvancedFilter filter in fld.AdvancedFilters) {
            if (filter.ID == fldVal && filter.Enabled) {
                ...
                if (!Empty(method))
                    ...
                    wrk = ConvertToString(typeof(project2).GetMethod(method)?.Invoke(null, [exp, dbid]));
                break;
            }
        }
        return wrk;
    ...
    */
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(project2).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(project2).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
