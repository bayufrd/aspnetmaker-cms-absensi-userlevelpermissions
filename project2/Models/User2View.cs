...
public partial class project2 {
    ...
    /// user2View
    /// </summary>
    public static User2View user2View
    {
        get => HttpData.Get<User2View>("user2View")!;
        set => HttpData["user2View"] = value;
    }

    /// <summary>
    /// Page class for user
    /// </summary>
    public class User2View : User2ViewBase
    {
        // Constructor
        public User2View(Controller controller) : base(controller)
        {
        }

        // Constructor
        public User2View() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class User2ViewBase : User2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "user2View";
        ...
        // Page name
        public string PageName => "User2View";
        ...
        // Constructor
        public User2ViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "User2List"; // Return to list
            }
