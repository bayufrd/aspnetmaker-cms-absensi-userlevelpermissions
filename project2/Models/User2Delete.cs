...
public partial class project2 {
    ...
    /// user2Delete
    /// </summary>
    public static User2Delete user2Delete
    {
        get => HttpData.Get<User2Delete>("user2Delete")!;
        set => HttpData["user2Delete"] = value;
    }

    /// <summary>
    /// Page class for user
    /// </summary>
    public class User2Delete : User2DeleteBase
    {
        // Constructor
        public User2Delete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public User2Delete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class User2DeleteBase : User2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "user2Delete";
        ...
        // Page name
        public string PageName => "User2Delete";
        ...
        // Constructor
        public User2DeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("User2List"); // Prevent SQL injection, return to List page
            ...
            using (Recordset = await Connection.ExecuteReaderAsync(sql, main: false)) {
                if (Recordset != null) {
                    ...
                    if (!res)
                        return Terminate("User2List"); // Return to List page
                }
            }
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("User2List"); // Return to list
                }
            }
