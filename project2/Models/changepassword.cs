...
public partial class project2 {
    ...
    public class ChangePasswordBase : Users
    {
        ...
        public DbField<MySqlDbType> OldPassword = new(Resolve("usertable"), "opwd", 200, MySqlDbType.VarString) {
                Name = "opwd",
                Expression = "opwd"
            };

        public DbField<MySqlDbType> NewPassword = new(Resolve("usertable"), "npwd", 200, MySqlDbType.VarString) {
                Name = "npwd",
                Expression = "npwd"
            };

        public DbField<MySqlDbType> ConfirmPassword = new(Resolve("usertable"), "cpwd", 200, MySqlDbType.VarString) {
                Name = "cpwd",
                Expression = "cpwd"
            };
