...
public partial class project2 {
    ...
    /// absensiEdit
    /// </summary>
    public static AbsensiEdit absensiEdit
    {
        get => HttpData.Get<AbsensiEdit>("absensiEdit")!;
        set => HttpData["absensiEdit"] = value;
    }

    /// <summary>
    /// Page class for absensi
    /// </summary>
    public class AbsensiEdit : AbsensiEditBase
    {
        // Constructor
        public AbsensiEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AbsensiEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AbsensiEditBase : Absensi
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "absensiEdit";
        ...
        // Page name
        public string PageName => "AbsensiEdit";
        ...
        // Constructor
        public AbsensiEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("AbsensiList"); // No matching record, return to list
                        }
                    break;
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // user_id
            user_id.SetDbValue(rsnew, user_id.CurrentValue, user_id.ReadOnly);

            // tanggal
            tanggal.SetDbValue(rsnew, ConvertToDateTime(tanggal.CurrentValue, tanggal.FormatPattern), tanggal.ReadOnly);

            // jam_masuk
            jam_masuk.SetDbValue(rsnew, ConvertToDateTime(jam_masuk.CurrentValue, jam_masuk.FormatPattern), jam_masuk.ReadOnly);

            // jam_keluar
            jam_keluar.SetDbValue(rsnew, ConvertToDateTime(jam_keluar.CurrentValue, jam_keluar.FormatPattern), jam_keluar.ReadOnly);
            ...
            // foto_verifikasi
            foto_verifikasi.SetDbValue(rsnew, foto_verifikasi.CurrentValue, foto_verifikasi.ReadOnly);
            return rsnew;
        }
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("foto_verifikasi", out value)) // foto_verifikasi
                foto_verifikasi.CurrentValue = value;
        }
