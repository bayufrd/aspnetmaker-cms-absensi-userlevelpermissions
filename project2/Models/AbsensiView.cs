...
public partial class project2 {
    ...
    /// absensiView
    /// </summary>
    public static AbsensiView absensiView
    {
        get => HttpData.Get<AbsensiView>("absensiView")!;
        set => HttpData["absensiView"] = value;
    }

    /// <summary>
    /// Page class for absensi
    /// </summary>
    public class AbsensiView : AbsensiViewBase
    {
        // Constructor
        public AbsensiView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AbsensiView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AbsensiViewBase : Absensi
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "absensiView";
        ...
        // Page name
        public string PageName => "AbsensiView";
        ...
        // Constructor
        public AbsensiViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "AbsensiList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("AbsensiList"); // Return to list page
                            }
                        }
                    break;
            }
