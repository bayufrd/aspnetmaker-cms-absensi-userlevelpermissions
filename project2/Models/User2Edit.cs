...
public partial class project2 {
    ...
    /// user2Edit
    /// </summary>
    public static User2Edit user2Edit
    {
        get => HttpData.Get<User2Edit>("user2Edit")!;
        set => HttpData["user2Edit"] = value;
    }

    /// <summary>
    /// Page class for user
    /// </summary>
    public class User2Edit : User2EditBase
    {
        // Constructor
        public User2Edit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public User2Edit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class User2EditBase : User2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "user2Edit";
        ...
        // Page name
        public string PageName => "User2Edit";
        ...
        // Constructor
        public User2EditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("User2List"); // No matching record, return to list
                        }
                    break;
