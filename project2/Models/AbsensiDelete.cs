...
public partial class project2 {
    ...
    /// absensiDelete
    /// </summary>
    public static AbsensiDelete absensiDelete
    {
        get => HttpData.Get<AbsensiDelete>("absensiDelete")!;
        set => HttpData["absensiDelete"] = value;
    }

    /// <summary>
    /// Page class for absensi
    /// </summary>
    public class AbsensiDelete : AbsensiDeleteBase
    {
        // Constructor
        public AbsensiDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AbsensiDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AbsensiDeleteBase : Absensi
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "absensiDelete";
        ...
        // Page name
        public string PageName => "AbsensiDelete";
        ...
        // Constructor
        public AbsensiDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("AbsensiList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("AbsensiList"); // Return to list
                }
            }
