...
public partial class project2 {
    ...
    /// user2Add
    /// </summary>
    public static User2Add user2Add
    {
        get => HttpData.Get<User2Add>("user2Add")!;
        set => HttpData["user2Add"] = value;
    }

    /// <summary>
    /// Page class for user
    /// </summary>
    public class User2Add : User2AddBase
    {
        // Constructor
        public User2Add(Controller controller) : base(controller)
        {
        }

        // Constructor
        public User2Add() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class User2AddBase : User2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "user2Add";
        ...
        // Page name
        public string PageName => "User2Add";
        ...
        // Constructor
        public User2AddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("User2List"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "User2List")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "User2View")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "User2List") {
                                ...
                                returnUrl = "User2List"; // Return list page content
                            }
                        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!Security.CanAdmin) { // System admin
                    ...
                    _userlevel.EditValue = _userlevel.Options(true);
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // userlevel
                if (Security.CanAdmin) { // System admin
                _userlevel.SetDbValue(rsnew, _userlevel.CurrentValue, Empty(_userlevel.CurrentValue));
                }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("User2List")), "", TableVar, true);
