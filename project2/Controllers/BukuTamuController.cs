...
public partial class HomeController : Controller
{
    ...
    public async Task<IActionResult> BukuTamuList()
    {
        ...
        // Check chart request
        if (RouteValues.TryGetValue("id", out object? rv)) {
            if (bukuTamuList.Charts.TryGetValue(ConvertToString(rv), out DbChart? chart) && chart != null)
                return await bukuTamuList.RunChart(chart.ChartVar);
        }
